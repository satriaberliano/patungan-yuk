      ...
      <main>
        <Routes>
          ...
          <Route
            ...
            element={<AddAnggotaPatunganPage />}
          ></Route>
          <Route
            path={AddKegiatanPatunganPath}
            element={<AddKegiatanPatunganPage />}
          ></Route>
          <Route
            path={AddJumlahPatunganAnggotaPath}
            element={<AddJumlahPatunganAnggotaPage />}
          ></Route>
          <Route path={EditKegiatanPath} element={<EditKegiatanPage />}></Route>
          <Route
            path={AddUangPatunganPath}
            element={<AddUangPatunganPage />}
          ></Route>
          <Route
            path={ChangeKegiatanPath}
            element={<ChangeKegiatanPatunganPage />}
          ></Route>
        </Routes>
      </main>
      <footer>
